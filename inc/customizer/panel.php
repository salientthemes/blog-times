...
$st_blog_panels['st-blog-homepage-panel']  = array(
	'title'			=> esc_html__('Theme Options','blog-times'),
	'priority'		=> 30	
);
...
// Ticker
$blog_times_gallery_path = st_blog_file_directory('inc/customizer/ticker/ticker.php');
require $blog_times_gallery_path;
